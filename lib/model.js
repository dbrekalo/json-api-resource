...
var Model = typeFactory({
    ...
    getProperty: function(key) {
        ...
        if (this.state.data.relationships[currentQuery]) {
            ...
            result = this.getAttribute(currentQuery);
    ...
    getAttribute: function(key) {
        ...
        return key === 'id' ? this.state.data.id : this.state.data.attributes[key];
    ...
    getRelation: function(name) {
        ...
        if (!relationData) {
            ...
            return self.includedCollection.getModel(relationData.id, relationData.type);
